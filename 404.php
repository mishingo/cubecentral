    ...
    <div id="primary" class="row">
        <main id="content" class="col-sm-8">
            <div class="error-404 not-found">
                    ...
                    <div class="resource-row clearfix">
                        ...
                        <?php while ($loop->have_posts()) : $loop->the_post(); ?>
                            ...
                            <div class="resource">
                                ...
                                <img src="<?php echo $resource_img['url']; ?>"
                                     alt="<?php echo $resource_img['alt']; ?>">
                            ...
                            <!-- end of div with class resource -->

                        <?php endwhile; ?>


                    </div>
                    <!-- end of div with class resource-row -->
                ...
                <!-- end of div with class page-content -->
            </div>
            <!-- end of div with class error-404 not-found -->
        </main>
        <!-- end of main  -->
